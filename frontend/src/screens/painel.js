...
import { DB, getForm, getPac, pacActive, formStatus, ownerName } from '../state.js';
...
export async function signAll() {
  try { const signed = await api.signAllToday(); await api.refreshState(); toast(`${signed.length} planilhas assinadas.`); rerender(); }
